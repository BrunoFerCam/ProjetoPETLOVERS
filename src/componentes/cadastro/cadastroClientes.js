...
export default function FormularioCadastrarCliente(props) {
    let tema = props.tema;
        ...
        <div className="container-fluid">
            ...
            {isExpanded && (
                <form>
                    ...
                    <div className="input-group mb-3">
                        <button className="btn btn-outline-secondary" type="button" style={{ background: props.tema }}>Cadastrar</button>
                    </div>
                </form>
            )}
        </div>
