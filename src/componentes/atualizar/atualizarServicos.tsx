...
export default class FormularioAtualizarServicos extends Component<Props> {
        ...
        return (
            <div className="container-fluid">
                <form>
                    ...
                    <div className="input-group mb-3">
                        <button className="btn btn-outline-secondary" type="button" style={{ background: tema }}>Atualizar Serviço</button>
                    </div>
                </form>
            </div>
        )
