...
export default function FormularioAtualizarProdutos(props: Props) {
        ...
        <div className="container-fluid">
            ...
            {isExpanded && (
                <form>
                    ...
                    <div className="input-group mb-3">
                        <button className="btn btn-outline-secondary" type="button" style={{ background: props.tema }}>Atualizar Produto</button>
                    </div>
                </form>
            )}
        </div>
